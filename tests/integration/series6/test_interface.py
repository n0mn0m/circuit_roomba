...
class Test_interface(unittest.TestCase):
    ...
    def test_roomba_responds_to_command(self):
        ...
        self.assertEqual(self.interface.history[0], opcode.POWER)

    def test_roomba_powers_off(self):
        self.interface.command(opcode.POWER)
        self.interface.command(opcode.STOP)
        self.assertEqual(self.interface.history[2][1], opcode.START)
        self.assertEqual(self.interface.history[1][1], opcode.POWER)
        self.assertEqual(self.interface.history[0][1], opcode.STOP)
    ...
    def test_roomba_wakes_backup_after_power_off(self):
        ...
        self.interface.command(opcode.POWER)
        self.interface.command(opcode.STOP)
        self.assertEqual(self.interface.history[4][1], opcode.POWER)
        self.assertEqual(self.interface.history[3][1], opcode.STOP)
        self.assertEqual(self.interface.history[2][1], opcode.START)
        self.assertEqual(self.interface.history[1][1], opcode.POWER)
        self.assertEqual(self.interface.history[0][1], opcode.STOP)
